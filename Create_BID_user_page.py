...
lbl_WorkOrder =       Label(FRAM_Bid_Cost_Eng, font=('arial', 16, 'bold'), text="NAME",              fg="black", bd=20).grid(row=0, column=0)
lbl_ENG =             Label(FRAM_Bid_Cost_Eng, font=('arial', 16, 'bold'), text="NAME",              fg="black", bd=20).grid(row=0, column=0)
      #===================================================================Bid_information===========================================
...
lbl_Customer =         Label(FRAM_Bid_information, font=('arial', 16, 'bold'), text="Execution_Time",    fg="black", bd=20).grid(row=12,column=0)
lbl_RFQ_No =           Label(FRAM_Bid_information, font=('arial', 16, 'bold'), text="RFQ_No",            fg="black", bd=20).grid(row=1, column=0)
lbl_Tender_Name =      Label(FRAM_Bid_information, font=('arial', 16, 'bold'), text="Tender_Name",       fg="black", bd=20).grid(row=2, column=0)
...
lbl_Received_Date =    Label(FRAM_Bid_Date, font=('arial', 16, 'bold'), text="Received_Date",     fg="black", bd=20).grid(row=5, column=0)
lbl_Closing_Date =     Label(FRAM_Bid_Date, font=('arial', 16, 'bold'), text="Closing_Date",      fg="black", bd=20).grid(row=6, column=0)
lbl_EvaluationDate =   Label(FRAM_Bid_Date, font=('arial', 16, 'bold'), text="EvaluationDate",    fg="black", bd=20).grid(row=7, column=0)
lbl_Execution_Time =   Label(FRAM_Bid_Date, font=('arial', 16, 'bold'), text="Execution_Time",    fg="black", bd=20).grid(row=11,column=0)
             #===================================================================Bid_Documnets====================================
FRAM_Bid_Documnets = Frame(BID_MainFrame, bd=16, width=700, height=600, relief=RAISED)
FRAM_Bid_Documnets.grid(row=1, column=1)

lbl_As_per_Standerd =  Label(FRAM_Bid_Documnets, font=('arial', 16, 'bold'), text="As_per_Standerd",   fg="black", bd=20).grid(row=9, column=0)
lbl_Tender_documents = Label(FRAM_Bid_Documnets, font=('arial', 16, 'bold'), text="Tender_documents",  fg="black", bd=20).grid(row=10,column=0)
lbl_Tender_Breakdowen= Label(FRAM_Bid_Documnets, font=('arial', 16, 'bold'), text="Tender_documents",  fg="black", bd=20).grid(row=10,column=0)
              #===================================================================Location===================================
FRAM_Bid_Location = Frame(BID_MainFrame, bd=16, width=700, height=600, relief=RAISED)
FRAM_Bid_Location.grid(row=0, column=0)
