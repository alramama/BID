...
with pdfplumber.open(openfile) as pdf:
    ...
    mytext = Text(Fram00, height=40, width = 100)
    mytext.grid()
    ...
    def v():
        ...
        a04 = (a0.index("MEMO TO VENDOR:"))
        #print(a4)
        ADDITIONAL_DATA01 = (a0[a4:])
        MEMO_TO_VENDOR = (a0[a04:])
        print(MEMO_TO_VENDOR)
        #****************************************
        #MEMO TO VENDOR:
        ...
        lbl_RFQ_no = Label(Fram01, font=('arial', 12, 'bold'), text="RFQ_no", fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        lbl_RFQ_no.grid(row=0, column=0)
        ent_RFQ_no = Entry(Fram01, font=('arial', 12, 'bold'), textvariable= RFQ_no, fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        ent_RFQ_no.grid(row=0, column=1)
        ent_RFQ_no.insert(0, RFQ_no1)
        #(ent_RFQ_no.get())

        lbl_BID_OPEN = Label(Fram01, font=('arial', 12, 'bold'), text="BID_OPEN", fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        lbl_BID_OPEN.grid(row=1, column=0)
        ent_BID_OPEN = Entry(Fram01, font=('arial', 12, 'bold'), textvariable= Bid_open, fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        ent_BID_OPEN.grid(row=1, column=1)
        ent_BID_OPEN.insert(0, Bid_open1)
        #(ent_BID_OPEN.get())

        lbl_Bid_close = Label(Fram01, font=('arial', 12, 'bold'), text="Bid_close", fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        lbl_Bid_close.grid(row=2, column=0)
        ent_Bid_close = Entry(Fram01, font=('arial', 12, 'bold'), textvariable= Bid_close, fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        ent_Bid_close.grid(row=2, column=1)
        ent_Bid_close.insert(0, Bid_close1)
        #(ent_Bid_close.get())


        lbl_BAYER_NAME = Label(Fram01, font=('arial', 12, 'bold'), text="BAYER_NAME", fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        lbl_BAYER_NAME.grid(row=3, column=0)
        ent_BAYER_NAME = Entry(Fram01, font=('arial', 12, 'bold'), textvariable= Bayer_Name, fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        ent_BAYER_NAME.grid(row=3, column=1)
        ent_BAYER_NAME.insert(0, Bayer_Name1)
        #(ent_BAYER_NAME.get())

        lbl_BAYER_TELPHONE = Label(Fram01, font=('arial', 12, 'bold'), text="BAYER_TELPHONE", fg="black", bd=5,width=20, bg="white",relief=RIDGE, justify='left')
        lbl_BAYER_TELPHONE.grid(row=4, column=0)
        ent_BAYER_TELPHONE = Entry(Fram01, font=('arial', 12, 'bold'), textvariable= Bayer_Telphone, fg="black", bd=5,width=20, bg="white",relief=RIDGE, justify='left')
        ent_BAYER_TELPHONE.grid(row=4, column=1)
        ent_BAYER_TELPHONE.insert(0, Bayer_Telphone1)
        #(ent_BAYER_TELPHONE.get())

        lbl_REQ_UNIT = Label(Fram01, font=('arial', 12, 'bold'), text="REQ_UNIT", fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        lbl_REQ_UNIT.grid(row=5, column=0)
        ent_REQ_UNIT = Entry(Fram01, font=('arial', 12, 'bold'), textvariable= Req_Unit, fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        ent_REQ_UNIT.grid(row=5, column=1)
        ent_REQ_UNIT.insert(0, Req_Unit1)
        #(ent_REQ_UNIT.get())

        lbl_REQ_QTY = Label(Fram01, font=('arial', 12, 'bold'), text="REQ_QTY", fg="black", bd=5, width=20, bg="white",relief=RIDGE,justify='left')
        lbl_REQ_QTY.grid(row=6, column=0)
        ent_REQ_QTY = Entry(Fram01, font=('arial', 12, 'bold'), textvariable= Req_Qty, fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        ent_REQ_QTY.grid(row=6, column=1)
        ent_REQ_QTY.insert(0, Req_Qty1)
        #(ent_REQ_QTY.get())
        #(type(ent_REQ_QTY.get()))

        lbl_Product_Name = Label(Fram01, font=('arial', 12, 'bold'), text="Product_Name",fg="black", bd=5, width=20, bg="white",relief=RIDGE)
        lbl_Product_Name.grid(row=7, column=0)
        ent_Product_Name = Entry(Fram01, font=('arial', 12, 'bold'), textvariable= Product_Name,fg="black", bd=5, width=40, bg="white",relief=RIDGE)
        ent_Product_Name.grid(row=7, column=1)
        a0 = (new.get("Product Name:"))
        ent_Product_Name.insert(0, a0)
        #(ent_Product_Name.get())
        lbl_Model1 = Label(Fram01, font=('arial', 12, 'bold'), text="Model", fg="black", bd=5, width=20,bg="white",relief=RIDGE, justify='left')
        lbl_Model1.grid(row=8, column=0)
        ent_Model1 = Entry(Fram01, font=('arial', 12, 'bold'), textvariable= Model, fg="black", bd=5, width=40,bg="white",relief=RIDGE, justify='left')
        ...
        for i in new:
            if i == "INTERNAL MATERIAL/S:":
                ...
                ent_CONNECTION = Entry(Fram01, font=('arial', 12, 'bold'), textvariable=CONNECTION, fg="black", bd=5,
                ...
                lbl_VOLTAGE = Label(Fram01, font=('arial', 12, 'bold'), text="VOLTAGE", fg="black", bd=5, width=20,bg="white", relief=RIDGE, justify='left')
                lbl_VOLTAGE.grid(row=11, column=0)
                ent_VOLTAGE = Entry(Fram01, font=('arial', 12, 'bold'), textvariable=VOLTAGE, fg="black", bd=5,width=40, bg="white", relief=RIDGE, justify='left')
                ...
                lbl_AMP_HOURS = Label(Fram01, font=('arial', 12, 'bold'), text="AMP_HOURS", fg="black", bd=5, width=20,
                                      bg="white", relief=RIDGE, justify='left')
                ...
                ent_GROUP_SIZE = Entry(Fram01, font=('arial', 12, 'bold'), textvariable=GROUP_SIZE, fg="black", bd=5,
                                       width=40, bg="white", relief=RIDGE, justify='left')
                ...
                ent_CELLS = Entry(Fram01, font=('arial', 12, 'bold'), textvariable=CELLS, fg="black", bd=5, width=40,bg="white", relief=RIDGE, justify='left')
                ent_CELLS.grid(row=16, column=1)
                a0 = (new.get("CELLS:"))
                ent_CELLS.insert(0, a0)
                #(ent_CELLS.get())
            elif i == "ADDITIONAL DATA:":
                lbl_ADDITIONAL_DATA = Label(Fram01, font=('arial', 12, 'bold'), text="ADDITIONAL_DATA", fg="black",bd=5, width=20, bg="white", relief=RIDGE, justify='left')
                lbl_ADDITIONAL_DATA.grid(row=17, column=0)
                ent_ADDITIONAL_DATA = Entry(Fram01, font=('arial', 12, 'bold'), textvariable=ADDITIONAL_DATA,fg="black", bd=5, width=40, relief=RIDGE, bg="white", justify='left')
...
def insert():
    db = mysql.connector.connect(user='root', passwd='12345678', host='localhost', database='naizak')
    cursor = db.cursor()
    sql = 'INSERT INTO BATTERY (Req_Unit,Req_Qty,Product_Name,Model,RFQ_no,INTERNAL_MATERIALS,CONNECTION,VOLTAGE,STANDARD_SPECIFICATION,SIZE,AMP_HOURS,GROUP_SIZE, CELLS,ADDITIONAL_DATA,Bayer_telephone,Bid_open,Bid_close,Bayer_Name) ' \
          'values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
    val = (Req_Unit.get(),Req_Qty.get(),Product_Name.get(),Model.get(),RFQ_no.get(),INTERNAL_MATERIALS.get(),CONNECTION.get(),VOLTAGE.get(),STANDARD_SPECIFICATION.get(),SIZE.get(),AMP_HOURS.get(),GROUP_SIZE.get(), CELLS.get(),ADDITIONAL_DATA.get(),Bayer_Telphone.get(),Bid_open.get(),Bid_close.get(),Bayer_Name.get())
...
btn1 = Button(Fram02,font=('arial', 12, 'bold'), text="Insert to MySql", fg="black", bd=5, width=20, bg="white",relief=RIDGE, justify='left',command=insert)
