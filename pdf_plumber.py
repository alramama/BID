  ...
  def v():
      ...
      for i in new:
        if i == "INTERNAL MATERIAL/S:":
          ...
          lbl_CONNECTION = Label(Fram01, font=('arial', 12, 'bold'), text="CONNECTION", fg="black", bd=20, width=10,bg="white", justify='left')
          lbl_CONNECTION.grid(row=10, column=0)
          ent_CONNECTION = Entry(Fram01, font=('arial', 12, 'bold'), textvariable=CONNECTION, fg="black", bd=20, width=10,bg="white", justify='left')
